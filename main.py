...
async def command_help(ctx):
    ...
    embed.add_field(name="~mbuild", value="Builds message database for the current server.", inline=True)
    embed.add_field(name="~wordusage [word]", value="Shows how many times a specific word has been used on the current server", inline=True)
    embed.add_field(name="~create.reference [name]", value="Creates a new character reference for the given name.", inline=True)
    embed.add_field(name="~update.reference [name] [parameter] [content]", value="Updates one parameter of a given character reference", inline=True)
    embed.add_field(name="~update.reference.all ", value="Allows user to update all parameters of given character reference.", inline=True)
    embed.add_field(name="~update.reference.image [name] <image attachment>", value="Updates reference image for given character reference.", inline=True)
    embed.add_field(name="~image.add [name] <image attachment>", value="Adds image for current character reference.", inline=True)
    embed.add_field(name="~image.get [name] [index / \"all\"]", value="Gets one or all images for given character reference", inline=True)
    embed.add_field(name="~reference [name]", value="Displays the given character reference.", inline=True)
    embed.add_field(name="~create.entry [name]", value="Creates a new encyclopedia entry for the given monster.", inline=True)
    embed.add_field(name="~update.entry [name] [parameter] [content]", value="Updates one parameter for the given monster entry.", inline=True)
    embed.add_field(name="~update.entry.all ", value="Allows user to enter all monster entry parameters in one command.", inline=True)
    embed.add_field(name="~update.entry.image [name] <image attachment>", value="Updates the reference image for the given monster entry", inline=True)
    embed.add_field(name="~entry.image.add [name] <image attachment>", value="Adds an image to the gven monster entry.", inline=True)
    embed.add_field(name="~entry.image.get [name] [index / \"all\"]", value="Gets one or all images for given monster entry", inline=True)
    embed.add_field(name="~entry [name]", value="Displays the given monster entry.", inline=True)
